  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4 pt-32 pb-16 dark:bg-[#0b1219]">
      ...
      <div className="relative z-10 flex w-full flex-col items-center">
        <div className="w-full max-w-md rounded-3xl border border-black/5 bg-white/95 p-8 shadow-2xl backdrop-blur-sm dark:border-white/10 dark:bg-[#111c27]/95 sm:p-10">
          ...
          <div className="flex items-center justify-center gap-2 text-sm font-medium text-[#2c6e9b] dark:text-[#5aa6d6]">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 rounded-full bg-white/80 px-6 py-3 text-xs text-[#1d3d5c] shadow-md backdrop-blur-sm dark:bg-white/5 dark:text-white/70 sm:gap-6 sm:text-sm">
