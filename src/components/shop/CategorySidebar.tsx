...
function getCategoryIcon(category: string) {
  ...
  if (c.includes("ceram") || c.includes("tile")) return Square3Stack3DIcon;
  if (c.includes("station") || c.includes("book")) return BookOpenIcon;
  if (c.includes("gift") || c.includes("souvenir") || c.includes("access"))
    return GiftIcon;
  if (c.includes("food") || c.includes("drink")) return CakeIcon;
  if (c.includes("home") || c.includes("decor")) return HomeIcon;
  return TagIcon;
}
